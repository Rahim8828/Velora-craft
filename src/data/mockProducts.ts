...
export const mockProducts: Product[] = [
  ...
  // Sofa & Chair Repair (13 products/services)
  {
    id: 'prod-21',
  ...
  },
  {
    ...
    description: 'Complete sofa fabric removal and fresh premium fabric application with frame inspection and protective spray coating.',
    shortDescription: 'Complete sofa fabric replacement',
    price: 8999,
    category: 'Sofa & Chair Repair',
  ...
  },
  {
    ...
    name: 'Sofa Cushion Repair',
    slug: 'sofa-cushion-repair',
    description: 'Expert seam inspection, reinforcement, patch repair, and partial filling with high-quality foam.',
    shortDescription: 'Cushion seam and foam repair',
    price: 2999,
    category: 'Sofa & Chair Repair',
    subcategory: 'Sofa & Upholstery',
    imageUrl: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    name: 'Sofa Foam Replacement',
    slug: 'sofa-foam-replacement',
    description: 'Old foam removal and high-density memory foam installation with compression testing and fabric re-fitting.',
    shortDescription: 'High-density foam replacement',
    price: 4999,
    category: 'Sofa & Chair Repair',
    subcategory: 'Sofa & Upholstery',
    imageUrl: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    name: 'Sofa Leather/Rexine Repair',
    slug: 'sofa-leather-rexine-repair',
    description: 'Deep cleaning, crack and tear sealing, discoloration removal, and protective wax conditioning for leather and rexine sofas.',
    shortDescription: 'Leather & rexine tear and crack repair',
    price: 3999,
    category: 'Sofa & Chair Repair',
    subcategory: 'Sofa & Upholstery',
    imageUrl: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    name: 'Sofa Wooden Frame Repair',
    slug: 'sofa-wooden-frame-repair',
    description: 'Structural inspection, joint tightening with reinforcement, crack filling, wood treatment, and protective finish application.',
    shortDescription: 'Wooden frame joint and crack repair',
    price: 5999,
    category: 'Sofa & Chair Repair',
    subcategory: 'Sofa & Upholstery',
    imageUrl: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    name: 'Sofa Recliner Mechanism Repair',
    slug: 'sofa-recliner-mechanism-repair',
    description: 'Mechanical system diagnosis, cable or spring replacement, motor lubrication, and lever adjustment for all recliner sofas.',
    shortDescription: 'Recliner motor, spring, and lever repair',
    price: 4499,
    category: 'Sofa & Chair Repair',
    subcategory: 'Sofa & Upholstery',
    imageUrl: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    name: 'Sofa Comprehensive Refinishing',
    slug: 'sofa-comprehensive-refinishing',
    description: 'Deep professional cleaning, stain & spot removal, surface sanding, and protective varnish/lacquer coating.',
    shortDescription: 'Deep cleaning and refinishing service',
    price: 6999,
    category: 'Sofa & Chair Repair',
    subcategory: 'Sofa & Upholstery',
    imageUrl: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    name: 'Complete Sofa Upholstery Service',
    slug: 'complete-sofa-upholstery-service',
    description: 'Full frame inspection, complete fabric removal and new application, cushion assessment & repair, with premium finishing.',
    shortDescription: 'All-inclusive sofa upholstery overhaul',
    price: 11999,
    category: 'Sofa & Chair Repair',
    subcategory: 'Sofa & Upholstery',
    imageUrl: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    description: 'Base and wheel inspection, armrest repair and reinforcement, seat cushion restoration, and upholstery patching.',
    shortDescription: 'Office chair base, wheel & armrest repair',
    price: 2499,
    category: 'Sofa & Chair Repair',
    subcategory: 'Sofa & Upholstery',
    imageUrl: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    description: 'Wooden frame inspection, joint tightening with reinforcement, seat upholstery restoration, and protective finish.',
    shortDescription: 'Dining chair frame and seat restoration',
    price: 1999,
    category: 'Sofa & Chair Repair',
    subcategory: 'Sofa & Upholstery',
    imageUrl: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    name: 'Chair Upholstery Change',
    slug: 'chair-upholstery-change',
    description: 'Old fabric removal, frame inspection, new fabric application, and professional edge finishing for all chairs.',
    shortDescription: 'Chair fabric removal and new upholstery',
    price: 3499,
    category: 'Sofa & Chair Repair',
    subcategory: 'Sofa & Upholstery',
    imageUrl: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    name: 'Cane/Wicker Chair Repair',
    slug: 'cane-wicker-chair-repair',
    description: 'Strand inspection, damaged strand replacement, frame joint tightening, and protective lacquer coating.',
    shortDescription: 'Cane & wicker strand replacement and repair',
    price: 2999,
    category: 'Sofa & Chair Repair',
    subcategory: 'Sofa & Upholstery',
    imageUrl: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=800&h=600&fit=crop',
